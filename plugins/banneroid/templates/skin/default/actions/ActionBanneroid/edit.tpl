...
<div class="page people">
    <form method="POST" action="" enctype="multipart/form-data" id="fmBanneroid">
        ...
        <br/>
        <label>
			{$aLang.banneroid_url} *не забудьте ввести hhtp:// <br/>
        ...
        <label>
            <input name="banner_type" type="radio" value="2" {if $_aRequest.banner_type==2}checked{/if} />
            {$aLang.banneroid_index_top} *размеры 330х380
        </label><br/>
        <label>
