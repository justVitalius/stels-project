...
smarty_core_load_plugins(array('plugins' => array(array('function', 'router', 'menu.profile.tpl', 4, false),array('function', 'hook', 'menu.profile.tpl', 10, false),)), $this); ?>
		<ul class="menu">
...
/favourites/comments/"><?php echo $this->_tpl_vars['aLang']['user_menu_profile_favourites_comments']; ?>
						...
						<?php echo smarty_function_hook(array('run' => 'menu_profile_profile_item'), $this);?>
...
/comment/"><?php echo $this->_tpl_vars['aLang']['user_menu_publication_comment']; ?>
						...
						<?php echo smarty_function_hook(array('run' => 'menu_profile_my_item'), $this);?>
