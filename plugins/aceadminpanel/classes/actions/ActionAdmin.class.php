...
class PluginAceadminpanel_ActionAdmin extends PluginAceadminpanel_Inherit_ActionAdmin
{
    ...
    public function Init()
    {
        ...
        $sPluginVersion = ACEADMINPANEL_VERSION . '.' . ACEADMINPANEL_VERSION_BUILD;
        $sHtmlTitle = $this->Lang_Get('adm_title') . ' v.' . $sPluginVersion; //$this->PluginAceadminpanel_Admin_getVersion();
        $this->Viewer_AddHtmlTitle($sHtmlTitle);
        $this->Viewer_Assign('sAdminTitle', 'aceAdminPanel v.' . $sPluginVersion); //$this->PluginAceadminpanel_Admin_getVersion();
    }
