{ foreach from=$aEvents item=oEvent }
   ...
   <p class="title-event"><a href="/blog/events/">Ближайшее событие</a></p>  
    <a href="/blog/events/{ $oEvent->getId() }.html">
        <img class="preview" src="{if $oEvent->getTopicPreview()}{$oEvent->getTopicPreviewPath(590,360)}{else}/templates/skin/developer/images/defaults/meeting_590x360.jpg{/if}" />
    </a>
