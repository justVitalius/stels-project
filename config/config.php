...
$config['view']['name']        = 'Энергоблог';                   // название сайта
$config['view']['description'] = 'Энергоблог-блог посвященный энергетии'; // seo description
$config['view']['keywords']    = 'энергоблог, энергетика, коммуникации';      // seo keywords
...
$config['sys']['mail']['from_email']       = 'tema.place@gmail.com'; // Мыло с которого отправляются все уведомления
$config['sys']['mail']['from_name']        = 'Энергоблог LiveStreet';  // Имя с которого отправляются все уведомления
...
$config['acl']['create']['comment']['limit_time']         =  0; // время в секундах между постингом комментариев, если 0 то ограничение по времени не будет работать 
...
$config['module']['blog']['index_good']      =  2;   // Рейтинг топика выше которого(включительно) он попадает на главную
...
// Модуль User
$config['module']['user']['per_page']    = 8;          // Число юзеров на страницу на странице статистики
...
$config['module']['user']['avatar_size'] = array(280, 145,110,100,64,48,24,0); // Список размеров аватаров у пользователя. 0 - исходный размер 
// Модуль Comment
...
$config['module']['image']['default']['watermark_text']       = '';
...
$config['block']['rule_index_blog'] = array(
	...
	'blocks'  => array(
			'right' => array(
				/*
				 * Блоки для компании Стэлс
				 * author: Sevastyan Rabdano
				 */
				'ads'=>array('priority'=>75),
				'news'=>array('priority'=>74),
				'qa'=>array('priority'=>73),
				'top'=>array('priority'=>72),
				'lacom'=>array('priority'=>71),
...
$config['block']['rule_profile'] = array(
	...
	'blocks'  => array( 'right' => array(
		'actions/ActionProfile/sidebar.tpl',
		'ads'=>array('priority'=>1),
		) ),
);
