	...
	<div id="header">
		...
		{if $sAction eq 'index'}
		<ul class="nav-main">
			<li class="active"><a href="{cfg name='path.root.web'}">Главная</a></li>
			<li><a href="{router page='blog'}">{$aLang.blogs}</a></li>
			<li><a href="{cfg name='path.root.web'}/blog/qa/">q&a</a></li>
			<li><a href="{router page='people'}">{$aLang.people}</a></li>
			<li><a href="{cfg name='path.root.web'}/blog/works/">Работы</a></li>
			<li><a href="{cfg name='path.root.web'}/blog/products/">Продукция</a></li>
			{hook run='main_menu'}
		</ul>
		{else}
		<ul class="nav-main">
			<li {if $sMenuHeadItemSelect=='home'}class="active"{/if}><a href="{cfg name='path.root.web'}">Главная</a></li>
			<li {if $sMenuHeadItemSelect=='blog' and $sEvent!='qa' and $sEvent!='works' and $sEvent!='products'}class="active"{/if}><a href="{router page='blog'}">{$aLang.blogs}</a></li>
			<li {if $sEvent=='qa'}class="active"{/if}><a href="{cfg name='path.root.web'}/blog/qa/">q&a</a></li>
			<li {if $sMenuHeadItemSelect=='people'}class="active"{/if}><a href="{router page='people'}">{$aLang.people}</a></li>
			<li {if $sEvent=='works'}class="active"{/if}><a href="{cfg name='path.root.web'}/blog/works/">Работы</a></li>
			<li {if $sEvent=='products'}class="active"{/if}><a href="{cfg name='path.root.web'}/blog/products/">Продукция</a></li> 
			{hook run='main_menu'}
		</ul>
		{/if}
