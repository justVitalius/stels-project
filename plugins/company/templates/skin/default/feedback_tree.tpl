<script type="text/javascript" src="{cfg name='path.root.web'}/plugins/company/templates/skin/default/js/feedbacks.js"></script>
			...
			<div class="comments">
				...
				<!-- Comments Header -->
				<div class="header">
					<h3>{$aLang.company_feedbacks_title}  (<span id="count-comments">{$oCompany->getCountFeedback()}</span>)</h3>
					<a name="comments" ></a>
				...
				{foreach from=$aComments item=oComment name=rublist}
    				...
    				<div class="comment" id="comment_id_{$oComment->getId()}">
    					...
    					{include file='../plugins/company/templates/skin/default/feedback.tpl'}      												
