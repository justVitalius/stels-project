...
$this->_smarty_include(array('smarty_include_tpl_file' => 'header.tpl', 'smarty_include_vars' => array('menu' => 'settings')));
...
<h2><?php echo $this->_tpl_vars['aLang']['settings_profile_edit']; ?>
</h2>
...
" class="input-200" /><br />
		<span class="note"><?php echo $this->_tpl_vars['aLang']['settings_profile_name_notice']; ?>
</span>
	</p>
	<p>
		<label for="mail"><?php echo $this->_tpl_vars['aLang']['settings_profile_mail']; ?>
:</label><br />
		<input type="text" name="mail" id="mail" value="<?php echo ((is_array($_tmp=$this->_tpl_vars['oUserCurrent']->getMail())) ? $this->_run_mod_handler('escape', true, $_tmp, 'html') : smarty_modifier_escape($_tmp, 'html')); ?>
" class="input-200" /><br />
		<span class="note"><?php echo $this->_tpl_vars['aLang']['settings_profile_mail_notice']; ?>
</span>
	</p>
	<p>
		<?php echo $this->_tpl_vars['aLang']['settings_profile_sex']; ?>
:<br />
		<label><input type="radio" name="profile_sex" id="profile_sex_m" value="man" <?php if ($this->_tpl_vars['oUserCurrent']->getProfileSex() == 'man'): ?>checked<?php endif; ?> class="checkbox" /><?php echo $this->_tpl_vars['aLang']['settings_profile_sex_man']; ?>
</label><br />
		<label><input type="radio" name="profile_sex" id="profile_sex_w" value="woman" <?php if ($this->_tpl_vars['oUserCurrent']->getProfileSex() == 'woman'): ?>checked<?php endif; ?> class="checkbox" /><?php echo $this->_tpl_vars['aLang']['settings_profile_sex_woman']; ?>
</label><br />
		<label><input type="radio" name="profile_sex" id="profile_sex_o"  value="other" <?php if ($this->_tpl_vars['oUserCurrent']->getProfileSex() == 'other'): ?>checked<?php endif; ?> class="checkbox" /><?php echo $this->_tpl_vars['aLang']['settings_profile_sex_other']; ?>
</label>
	</p>
	<p>
...
:</label><br /><input type="text" id="profile_country" name="profile_country" value="<?php echo ((is_array($_tmp=$this->_tpl_vars['oUserCurrent']->getProfileCountry())) ? $this->_run_mod_handler('escape', true, $_tmp, 'html') : smarty_modifier_escape($_tmp, 'html')); ?>
" /><br />
		<label for="profile_city"><?php echo $this->_tpl_vars['aLang']['settings_profile_city']; ?>
:</label><br /><input type="text" id="profile_city" name="profile_city" value="<?php echo ((is_array($_tmp=$this->_tpl_vars['oUserCurrent']->getProfileCity())) ? $this->_run_mod_handler('escape', true, $_tmp, 'html') : smarty_modifier_escape($_tmp, 'html')); ?>
" /><br />
	</p>

	<p><label for="profile_icq"><?php echo $this->_tpl_vars['aLang']['settings_profile_icq']; ?>
:</label><br /><input type="text" name="profile_icq" id="profile_icq" value="<?php echo ((is_array($_tmp=$this->_tpl_vars['oUserCurrent']->getProfileIcq())) ? $this->_run_mod_handler('escape', true, $_tmp, 'html') : smarty_modifier_escape($_tmp, 'html')); ?>
"/></p>

	<p>
		<label for="profile_site"><?php echo $this->_tpl_vars['aLang']['settings_profile_site']; ?>
:</label><br />
		<label for="profile_site"><input type="text" style="margin-bottom: 5px;" id="profile_site" name="profile_site" value="<?php echo ((is_array($_tmp=$this->_tpl_vars['oUserCurrent']->getProfileSite())) ? $this->_run_mod_handler('escape', true, $_tmp, 'html') : smarty_modifier_escape($_tmp, 'html')); ?>
" /> &mdash; <?php echo $this->_tpl_vars['aLang']['settings_profile_site_url']; ?>
</label><br />
		<label for="profile_site_name"><input type="text" id="profile_site_name" name="profile_site_name" value="<?php echo ((is_array($_tmp=$this->_tpl_vars['oUserCurrent']->getProfileSiteName())) ? $this->_run_mod_handler('escape', true, $_tmp, 'html') : smarty_modifier_escape($_tmp, 'html')); ?>
...
:</label><br />
		<textarea class="input-300" name="profile_job" id="profile_job"><?php echo ((is_array($_tmp=$this->_tpl_vars['oUserCurrent']->getProfileJob())) ? $this->_run_mod_handler('escape', true, $_tmp, 'html') : smarty_modifier_escape($_tmp, 'html')); ?>
</textarea>
	</p>
...
:</label><br /><input type="password" id="password"	name="password" value="" /><br />
		<label for="password_confirm"><?php echo $this->_tpl_vars['aLang']['settings_profile_password_confirm']; ?>
:</label><br /><input type="password" id="password_confirm"	name="password_confirm" value="" />
	</p>
...
" /><br />
		<input type="checkbox" id="avatar_delete" name="avatar_delete" value="on" class="checkbox" /><label for="avatar_delete"><?php echo $this->_tpl_vars['aLang']['settings_profile_avatar_delete']; ?>
</label><br /><br />
	<?php endif; ?>
...
" /><br />
		<input type="checkbox" id="foto_delete" name="foto_delete" value="on" class="checkbox" /><label for="foto_delete"><?php echo $this->_tpl_vars['aLang']['settings_profile_foto_delete']; ?>
</label><br /><br />
	<?php endif; ?>
