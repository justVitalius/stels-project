...
<form action="" method="POST">
    ...
    <p><label for="page_other_url">Переадресация на страницу:</label><br />  
	   <input type="text" id="page_other_url" name="page_other_url" value="{$_aRequest.page_other_url}" class="w100p" /><br /></p>


    <p><label for="page_text">{$oLang->page_create_text}:</label>
    {if !$oConfig->GetValue('view.tinymce')}
    <div class="panel_form" style="background: #eaecea; ">
        <a href="#" onclick="lsPanel.putTagAround('page_text','b'); return false;" class="button"><img src="{cfg name='path.static.skin'}/images/panel/bold.png" width="20" height="20" title="{$aLang.panel_b}" alt="{$aLang.panel_b}"/></a>
        <a href="#" onclick="lsPanel.putTagAround('page_text','i'); return false;" class="button"><img src="{cfg name='path.static.skin'}/images/panel/italic.png" width="20" height="20" title="{$aLang.panel_i}" alt="{$aLang.panel_i}"/></a>
        <a href="#" onclick="lsPanel.putTagAround('page_text','u'); return false;" class="button"><img src="{cfg name='path.static.skin'}/images/panel/underline.png" width="20" height="20" title="{$aLang.panel_u}" alt="{$aLang.panel_u}"/></a>
        <a href="#" onclick="lsPanel.putTagAround('page_text','s'); return false;" class="button"><img src="{cfg name='path.static.skin'}/images/panel/strikethrough.png" width="20" height="20" title="{$aLang.panel_s}" alt="{$aLang.panel_s}"/></a>
        &nbsp;
        <a href="#" onclick="lsPanel.putTagUrl('page_text','Введите ссылку'); return false;" class="button"><img src="{cfg name='path.static.skin'}/images/panel/link.png" width="20" height="20"  title="{$aLang.panel_url}" alt="{$aLang.panel_url}"/></a>
        <a href="#" onclick="lsPanel.putTagAround('page_text','code'); return false;" class="button"><img src="{cfg name='path.static.skin'}/images/panel/code.png" width="30" height="20" title="{$aLang.panel_code}" alt="{$aLang.panel_code}"/></a>
        <a href="#" onclick="lsPanel.putTagAround('page_text','video'); return false;" class="button"><img src="{cfg name='path.static.skin'}/images/panel/video.png" width="20" height="20" title="{$aLang.panel_video}" alt="{$aLang.panel_video}"/></a>

        <a href="#" onclick="showImgUploadForm(); return false;" class="button"><img src="{cfg name='path.static.skin'}/images/panel/img.png" width="20" height="20" title="{$aLang.panel_image}" alt="{$aLang.panel_image}"/></a>
        <a href="#" onclick="lsPanel.putText('page_text','<cut>'); return false;" class="button"><img src="{cfg name='path.static.skin'}/images/panel/cut.png" width="20" height="20" title="{$aLang.panel_cut}" alt="{$aLang.panel_cut}"/></a>
    </div>
    {/if}
...
<p>
    <input type="checkbox" id="page_main" name="page_main" value="1" {if $_aRequest.page_main==1}checked{/if}/>
...
<p class="buttons">					
    ...
    <input type="submit" name="submit_page_cancel" value="{$oLang->page_create_submit_cancel}" onclick="window.location='{router page='admin'}pages/'; return false;" />&nbsp;
</p>
