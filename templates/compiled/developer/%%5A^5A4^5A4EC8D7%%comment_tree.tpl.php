<?php /* Smarty version 2.6.19, created on 2011-09-09 19:42:43
         compiled from comment_tree.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'cfg', 'comment_tree.tpl', 1, false),array('function', 'router', 'comment_tree.tpl', 16, false),array('function', 'hook', 'comment_tree.tpl', 81, false),)), $this); ?>
...
<div class="comments">
	<?php if ($this->_tpl_vars['oUserCurrent']): ?>
		<div class="update" id="update">
			<div class="refresh"><img class="update-comments" id="update-comments" alt="" src="<?php echo smarty_function_cfg(array('name' => 'path.static.skin'), $this);?>
...
?></div></div><?php endfor; endif; ?>    
	...
	<?php else: ?>
		<?php if ($this->_tpl_vars['oUserCurrent']): ?>
			<h3><a href="javascript:lsCmtTree.toggleCommentForm(0);"><?php echo $this->_tpl_vars['sNoticeCommentAdd']; ?>
</a></h3>						
			...
			<div style="display: block;" id="reply_0" class="reply">						
				<?php if (! $this->_tpl_vars['oConfig']->GetValue('view.tinymce')): ?>
					<div class="panel-form">       	 
						<a href="#" onclick="lsPanel.putTagAround('form_comment_text','b'); return false;"><img src="<?php echo smarty_function_cfg(array('name' => 'path.static.skin'), $this);?>
/images/panel/bold_ru.gif" width="20" height="20" title="<?php echo $this->_tpl_vars['aLang']['panel_b']; ?>
"></a>
						<a href="#" onclick="lsPanel.putTagAround('form_comment_text','i'); return false;"><img src="<?php echo smarty_function_cfg(array('name' => 'path.static.skin'), $this);?>
/images/panel/italic_ru.gif" width="20" height="20" title="<?php echo $this->_tpl_vars['aLang']['panel_i']; ?>
"></a>	 			
						<a href="#" onclick="lsPanel.putTagAround('form_comment_text','u'); return false;"><img src="<?php echo smarty_function_cfg(array('name' => 'path.static.skin'), $this);?>
/images/panel/underline_ru.gif" width="20" height="20" title="<?php echo $this->_tpl_vars['aLang']['panel_u']; ?>
"></a>	 			
						<a href="#" onclick="lsPanel.putTagAround('form_comment_text','s'); return false;"><img src="<?php echo smarty_function_cfg(array('name' => 'path.static.skin'), $this);?>
...
"></a>
						<a href="#" onclick="lsPanel.putQuote('form_comment_text'); return false;"><img src="<?php echo smarty_function_cfg(array('name' => 'path.static.skin'), $this);?>
/images/panel/quote.gif" width="20" height="20" title="<?php echo $this->_tpl_vars['aLang']['panel_quote']; ?>
"></a>
						<a href="#" onclick="lsPanel.putTagAround('form_comment_text','code'); return false;"><img src="<?php echo smarty_function_cfg(array('name' => 'path.static.skin'), $this);?>
