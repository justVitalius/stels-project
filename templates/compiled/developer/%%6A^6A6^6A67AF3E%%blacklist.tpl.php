...
<div class="block">
	<h2><?php echo $this->_tpl_vars['aLang']['talk_blacklist_title']; ?>
</h2>
...
</a> - <a href="#" id="blacklist_item_<?php echo $this->_tpl_vars['oUser']->getId(); ?>
" onclick="deleteFromBlackList(this); return false;" class="delete"><?php echo $this->_tpl_vars['aLang']['blog_delete']; ?>
</a></li>
				<?php endforeach; endif; unset($_from); ?>
			</ul>
		<?php endif; ?>
	</div>
	<div class="bottom"><a href="#" id="list_uncheck_all" <?php if (! $this->_tpl_vars['aUsersBlacklist']): ?>style="display:none;"<?php endif; ?>><?php echo $this->_tpl_vars['aLang']['talk_balcklist_delete_all']; ?>
</a></div>
</div>