<?php /* Smarty version 2.6.19, created on 2011-10-03 13:25:04
...
<div class="profile-user">
	<?php if ($this->_tpl_vars['sEvent'] == 'add'): ?>
		<h2><?php echo $this->_tpl_vars['aLang']['topic_topic_create']; ?>
</h2>
	<?php else: ?>
		<h2><?php echo $this->_tpl_vars['aLang']['topic_topic_edit']; ?>
</h2>
	<?php endif; ?>
...
" class="input-wide" /><br />
		<span class="note"><?php echo $this->_tpl_vars['aLang']['topic_create_title_notice']; ?>
</span></p>

		<label for="topic_text"><?php echo $this->_tpl_vars['aLang']['topic_create_text']; ?>
<?php if (! $this->_tpl_vars['oConfig']->GetValue('view.tinymce')): ?> (<?php echo $this->_tpl_vars['aLang']['topic_create_text_notice']; ?>
)<?php endif; ?>:</label>
		<?php if (! $this->_tpl_vars['oConfig']->GetValue('view.tinymce')): ?>
			<div class="panel-form">
				...
				<a href="#" onclick="lsPanel.putTagAround('topic_text','b'); return false;"><img src="<?php echo smarty_function_cfg(array('name' => 'path.static.skin'), $this);?>
/images/panel/bold_ru.gif" width="20" height="20" title="<?php echo $this->_tpl_vars['aLang']['panel_b']; ?>
" /></a>
				<a href="#" onclick="lsPanel.putTagAround('topic_text','i'); return false;"><img src="<?php echo smarty_function_cfg(array('name' => 'path.static.skin'), $this);?>
/images/panel/italic_ru.gif" width="20" height="20" title="<?php echo $this->_tpl_vars['aLang']['panel_i']; ?>
" /></a>
				<a href="#" onclick="lsPanel.putTagAround('topic_text','u'); return false;"><img src="<?php echo smarty_function_cfg(array('name' => 'path.static.skin'), $this);?>
/images/panel/underline_ru.gif" width="20" height="20" title="<?php echo $this->_tpl_vars['aLang']['panel_u']; ?>
" /></a>
				<a href="#" onclick="lsPanel.putTagAround('topic_text','s'); return false;"><img src="<?php echo smarty_function_cfg(array('name' => 'path.static.skin'), $this);?>
...
'); return false;"><img src="<?php echo smarty_function_cfg(array('name' => 'path.static.skin'), $this);?>
/images/panel/link.gif" width="20" height="20"  title="<?php echo $this->_tpl_vars['aLang']['panel_url']; ?>
" /></a>
				<a href="#" onclick="lsPanel.putQuote('topic_text'); return false;"><img src="<?php echo smarty_function_cfg(array('name' => 'path.static.skin'), $this);?>
/images/panel/quote.gif" width="20" height="20" title="<?php echo $this->_tpl_vars['aLang']['panel_quote']; ?>
" /></a>
				<a href="#" onclick="lsPanel.putTagAround('topic_text','code'); return false;"><img src="<?php echo smarty_function_cfg(array('name' => 'path.static.skin'), $this);?>
/images/panel/code.gif" width="30" height="20" title="<?php echo $this->_tpl_vars['aLang']['panel_code']; ?>
" /></a>
				<a href="#" onclick="lsPanel.putTagAround('topic_text','video'); return false;"><img src="<?php echo smarty_function_cfg(array('name' => 'path.static.skin'), $this);?>
/images/panel/video.gif" width="20" height="20" title="<?php echo $this->_tpl_vars['aLang']['panel_video']; ?>
" /></a>

				<a href="#" onclick="showImgUploadForm(); return false;"><img src="<?php echo smarty_function_cfg(array('name' => 'path.static.skin'), $this);?>
/images/panel/img.gif" width="20" height="20" title="<?php echo $this->_tpl_vars['aLang']['panel_image']; ?>
" /></a>
				<a href="#" onclick="lsPanel.putText('topic_text','<cut>'); return false;"><img src="<?php echo smarty_function_cfg(array('name' => 'path.static.skin'), $this);?>
/images/panel/cut.gif" width="20" height="20" title="<?php echo $this->_tpl_vars['aLang']['panel_cut']; ?>
" /></a>
			</div>
		<?php endif; ?>
		<textarea name="topic_text" id="topic_text" rows="20" class="input-wide"><?php echo $this->_tpl_vars['_aRequest']['topic_text']; ?>
</textarea><br /><br />
...
" class="input-wide" /><br />
		<span class="note"><?php echo $this->_tpl_vars['aLang']['topic_create_tags_notice']; ?>
</span></p>
		...
		<?php echo $this->_tpl_vars['aLang']['topic_create_forbid_comment']; ?>
</label><br />
		<span class="note"><?php echo $this->_tpl_vars['aLang']['topic_create_forbid_comment_notice']; ?>
</span></p>
		...
		<?php if ($this->_tpl_vars['oUserCurrent']->isAdministrator()): ?>
			...
			<?php echo $this->_tpl_vars['aLang']['topic_create_publish_index']; ?>
</label><br />
